...
# Dicionário de transformações específicas de sensor e ótica
AUGMENTATIONS = {
...
def generate_augmented_copies(img_path, boxes, dir_output_img, dir_output_lbl, base_name, target_classes=None):
    ...
    for sufixo, transformacao in AUGMENTATIONS.items():
        try:
